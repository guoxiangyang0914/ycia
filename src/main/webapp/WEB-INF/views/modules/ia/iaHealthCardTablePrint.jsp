   ...
   <tbody>
    <tr> 
     ...
     <td width="220" align="center"> 
		 <input name="birth" id="birth" value="${iaHealthCard.birth }" size="4" maxlength="4" type="text" class="border0" style="width:40px" readonly="readonly"/>年
		 <input name="birth" id="birth" value="${iaHealthCard.birth }" size="2" maxlength="2" type="text" class="border0" style="width:20px" readonly="readonly"/>月
		 <input name="birth" id="birth" value="${iaHealthCard.birth }" size="2" maxlength="2" type="text" class="border0" style="width:20px" readonly="readonly"/>日
	 </td> 
    </tr> 
	<tr>
