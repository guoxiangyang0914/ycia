  ...
  <table width="649" border="1" cellpadding="0" cellspacing="0" style="border-top:0;"> 
   <tbody>
    ...
    <tr> 
     ...
     <td align="center">
		<input type="text" name="height" class="border0" style="width:60%;" value="${iaHealthCheck.height }" />
		cm
	 </td>
     <td class="bordertop0" align="center">体&nbsp;&nbsp;&nbsp;&nbsp;重</td> 
     <td align="center" colspan="2">
		<input type="text" name="weight" class="border0" style="width:81%;" value="${iaHealthCheck.weight }"  />
		kg
	 </td>  
    </tr> 
    <tr> 
     ...
     <td align="center" colspan="2">
		<input type="text" name="bmi" class="border0" style="width:76%;" value="${iaHealthCheck.bmi }" />
		Kg/㎡
	 </td>  
    </tr>
    <tr> 
...
7其他<input type="text" name="hazards" class="borderBot1" size="33" />
	...
	<input id="btnSubmit" class="btn btn-primary" type="button" value="打    印" onclick="return doPrint('打印预览')" />
